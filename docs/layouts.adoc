...
image:cs-part-nextjsviewed.png[title="Layout placed to the front page",width=700px]
TODO: Update this image
image:cs-part-nextjsviewed.png[title="Layout with components placed inside",width=700px]
